...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (Integer.parseInt(mas3[0]) == 1) {
            if (rim.arab(mas3[1],mas3[3])) { // проверяем арабские числа пришили или нет.
                a = Integer.parseInt(mas3[1]); // записываем в переменную первое число
                b = Integer.parseInt(mas3[3]); // записываем в переменную первое число
            }
            if (rim.in_rimskoe(mas3[1], mas3[3])) { // проверяем римские чила пришили или нет
